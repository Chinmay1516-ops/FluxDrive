...
def calculate_true_range(car_specs, start_lat, start_lon, end_lat, end_lon, ors_key, weather_key, target_speed_kmh=70):
    """ The Master Controller: Combines Maps, Weather, and Physics. """
    ...
    print(f"Adaptive Terrain analysis for {len(points)} road segments...")
    ...
    remaining_kwh = battery_size - total_energy_kwh
